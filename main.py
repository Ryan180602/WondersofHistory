...
def ordinalday(n): return "%d%s" % (
    n, "tsnrhtdd"[(n//10 % 10 != 1)*(n % 10 < 4)*n % 10::4])


def date_today():
    # datetime module allows the program to retrieve today's day and month values from the system
...
btn = tk.Button(text="click to see events",
                command=text_change, width=150, height=25)
